...
<body class="bg-primary text-gray-800">
                                          ...
                                          <div class="flex justify-between h-16">
                                                        <div class="flex items-center">
                                                                      ...
                                                                      <div class="hidden md:ml-6 md:flex md:space-x-8">
                                                                                    <a href="#home" class="border-accent text-gray-800 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                                                                                  Home
                                                                                    </a>
                                                                                    <a href="#services" class="border-transparent text-gray-600 hover:border-accent hover:text-accent inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                                                                                  Services
                                                                                    </a>
                                                                                    <a href="#doctors" class="border-transparent text-gray-600 hover:border-accent hover:text-accent inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                                                                                  Find Doctors
                                                                                    </a>
                                                                                    <a href="#testimonials" class="border-transparent text-gray-600 hover:border-accent hover:text-accent inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                                                                                  Testimonials
                                                                                    </a>
                                                                                    <a href="#contact" class="border-transparent text-gray-600 hover:border-accent hover:text-accent inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                                                                                  Contact
                                                                                    </a>
                                                                      </div>
                                                        </div>
                                                        <div class="hidden md:flex md:items-center md:space-x-4">
                                                                      <a href="{{ route('login')}}" class="text-gray-600 hover:text-accent px-3 py-2 rounded-md text-sm font-medium">Login</a>
                                                                      <a href="{{ route('register')}}" class="bg-accent hover:bg-darkTeal text-white px-4 py-2 rounded-md text-sm font-medium">Register</a>
                                                        </div>
                                                        <div class="-mr-2 flex items-center md:hidden">
                                                                      <button type="button" class="bg-white inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-accent hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-accent" aria-expanded="false">
              ...
              <!-- Hero Section -->
              <section id="home" class="relative bg-gradient-to-r from-accent to-darkTeal py-20">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                                        ...
                                                        <div class="lg:w-1/2">
                                                                      ...
                                                                      <div class="mt-4 sm:flex">
                                                                                    <div class="rounded-md shadow">
                                                                                                  <a href="#services" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-accent bg-white hover:bg-gray-100 md:py-4 md:text-lg md:px-10">
                                                                                                                Book Appointment
                                                                                                  </a>
                                                                                    </div>
                                                                                    <div class="mt-3 sm:mt-0 sm:ml-3">
                                                                                                  <a href="#services" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-darkTeal bg-opacity-80 hover:bg-opacity-100 md:py-4 md:text-lg md:px-10">
                                                                                                                Learn More
                                                                                                  </a>
                                                                                    </div>
                                                                      </div>
                            ...
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                                                        ...
                                                        <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                                                                      <div class="p-6">
                                                                                    <div class="flex items-center justify-center h-16 w-16 rounded-full bg-accent bg-opacity-10 text-accent mx-auto">
                                                                                    ...
                                                                                    <div class="mt-6 text-center">
                                                                                                  <a href="#" class="inline-flex items-center text-accent hover:text-darkTeal">
                                                                                                                Book Now
                                                        ...
                                                        <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                                                                      <div class="p-6">
                                                                                    ...
                                                                                    <div class="mt-6 text-center">
                                                                                                  <a href="#doctors" class="inline-flex items-center text-accent hover:text-darkTeal">
                                                                                                                Find Doctors
                                                                                                                <svg class="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                                                                                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                                                                                                </svg>
              ...
              <section id="doctors" class="py-16 bg-secondary">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                                                        <!-- Doctor Cards -->
                                                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                                                                      ...
                                                                      <div class="p-6">
                                                                                    ...
                                                                                    <div class="mt-4">
                                                                                                  <a href="#" class="block w-full bg-accent hover:bg-darkTeal text-white text-center py-2 rounded-md">Book Appointment</a>
                                                                                    </div>
                                                                      </div>
                                                        </div>
              ...
              <section id="testimonials" class="py-16 bg-lightGray">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                          ...
                                          <div class="mt-16 grid gap-8 md:grid-cols-3">
                                                        <!-- Testimonials -->
                                                        <div class="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200">
                            ...
                            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                                          ...
                                          <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                                                        <div class="inline-flex rounded-md shadow">
                                                                      <a href="{{ route('register')}}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-accent bg-white hover:bg-gray-100">
                                                                                    Register Now
                                                                      </a>
                                                        </div>
                                                        <div class="ml-3 inline-flex rounded-md shadow">
                                                                      <a href="#services" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-darkTeal hover:bg-opacity-90">
                                                                                    Learn More
                                                                      </a>
                                                        </div>
                                          </div>
                            ...
                            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                                          <div class="xl:grid xl:grid-cols-4 xl:gap-8">
                                                        ...
                                                        <div class="mt-12 grid grid-cols-3 gap-8 xl:mt-0 xl:col-span-3">
                                                                      <div>
                                                                                    <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Services</h3>
                                                                                    <ul class="mt-4 space-y-4">
                                                                                                  <li><a href="#services" class="text-base text-gray-300 hover:text-accent">Online Booking</a></li>
                                                                                                  <li><a href="#doctors" class="text-base text-gray-300 hover:text-accent">Find Doctors</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Health Records</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Medication Reminders</a></li>
                                                                                    </ul>
                                                                      </div>
                                                                      <div>
                                                                                    <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Company</h3>
                                                                                    <ul class="mt-4 space-y-4">
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">About</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Blog</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Careers</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Press</a></li>
                                                                                    </ul>
                                                                      </div>
                                                                      <div>
                                                                                    <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">Legal</h3>
                                                                                    <ul class="mt-4 space-y-4">
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Privacy Policy</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Terms of Service</a></li>
                                                                                                  <li><a href="#" class="text-base text-gray-300 hover:text-accent">Cookie Policy</a></li>
                                                                                                  <li><a href="#contact" class="text-base text-gray-300 hover:text-accent">Contact Us</a></li>
                                                                                    </ul>
                                                                      </div>
                                                        </div>
                                          </div>
