              ...
              <div class="flex h-screen overflow-hidden relative">
                            ...
                            <div id="sidebar" class="bg-sidebarBg text-gray-800 w-64 space-y-6 py-5 px-3 fixed inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out z-20 shadow-sidebar">
                                          ...
                                          <nav class="px-3 space-y-1">
                                                        ...
                                                        <a href="{{ route('patient.dashboard') }}" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('patient.dashboard') ? 'active' : '' }}">
                                                        ...
                                                        <a href="" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('patient.medical-records*') ? 'active' : '' }}">
                                                                      <i class="fas fa-file-medical w-5 text-center"></i>
                                                                      <span>Medical Records</span>
                                                        </a>
                                                        
                                                        <a href="" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('patient.prescriptions*') ? 'active' : '' }}">
                                                        ...
                                                        <a href="{{route('patient.profile')}}" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('patient.profile*') ? 'active' : '' }}">
                                                                      <i class="fas fa-user-circle w-5 text-center"></i>
                                                                      <span>My Profile</span>
                                                        </a>
                                                        
                                                        <a href="" class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg">
                                                                      <i class="fas fa-cog w-5 text-center"></i>
                                                                      <span>Settings</span>
                                                        </a>
                                                        
                                                        <div class="pt-6 border-t border-gray-200 mt-6">
                                                                      <form method="POST" action="" class="flex items-center space-x-3 px-4 py-3 rounded-lg sidebar-link hover:bg-red-100 group">
                                                                                    @csrf
                                                                      ...
                                                                      <div class="flex items-center space-x-4">
                                                                                    ...
                                                                                    <div class="relative">
                                                                                                  ...
                                                                                                  <div id="user-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 z-20 hidden">
                                                                                                                ...
                                                                                                                <a href="{{ route('logout')}}" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100">Logout</a>
                                                                                                  </div>
                                                                                    </div>
                                                                      </div>
                                                        </div>
