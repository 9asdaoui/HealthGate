        ...
        <div id="sidebar"
            ...
            <div class="mx-4 p-4 mb-6 rounded-xl bg-gradient-to-r from-gray-100 to-white shadow-md">
                <div class="flex items-center space-x-3">
                    <div
                        ...
                        @if ($user->image)
                            <img src="{{ $user->image }}" alt="Doctor's photo"
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-gray-800">Dr. {{ $user->first_name }}
                            {{ $user->last_name }}</h3>
            ...
            <nav class="px-3 space-y-1">
                ...
                <a href="{{ route('doctor.dashboard') }}"
                    class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('doctor.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-chart-line w-5 text-center"></i>
                    <span>Dashboard</span>
                </a>

                <a href="{{ route('doctor.appointments') }}"
                    class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('doctor.appointments*') ? 'active' : '' }}">
                ...
                <a href="{{ route('doctor.patients') }}"
                    class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('doctor.patients*') ? 'active' : '' }}">
                ...
                <a href="{{ route('doctor.diseases') }}"
                    class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('doctor.diseases*') ? 'active' : '' }}">
                ...
                <a href="{{ route('doctor.profile') }}"
                    class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('doctor.profile*') ? 'active' : '' }}">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button
                                ...
                                <span
                                    class="notification-badge absolute top-1 right-1 h-2 w-2 bg-accent rounded-full"></span>
                            </button>
                        </div>
                        ...
                        <div class="relative">
                            <button id="user-menu-btn" class="flex items-center space-x-2 focus:outline-none">
                                ...
                                <div class="hidden md:block text-left">
                                    <span class="block text-sm font-medium">Dr.
                                        {{ $user->first_name ?? 'Guest User' }}</span>
                                    <span
                                        class="block text-xs text-gray-500">{{ $user->doctor->speciality ?? 'Doctor' }}</span>
                                </div>
