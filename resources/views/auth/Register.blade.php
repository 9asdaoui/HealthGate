    ...
    <nav class="bg-primary shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('login') }}" class="text-gray-400 hover:text-accent px-3 py-2 rounded-md text-sm font-medium">
            ...
            <div class="md:flex">
                ...
                <div class="w-full md:w-1/2 p-6 md:p-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-400 mt-2">Fill out the form to get started</p>
                    </div>

                    <!-- Progress Steps -->
                    <div class="flex justify-between items-center mb-8">
                        <div class="flex flex-col items-center">
                            <div id="step1-indicator" class="w-8 h-8 bg-gray-800 step-active border-2 rounded-full flex items-center justify-center text-white font-bold">1</div>
                            <span class="text-xs mt-1 text-gray-400">Account</span>
                        </div>
                        <div class="flex-1 h-1 bg-gray-700 mx-2"></div>
                        <div class="flex flex-col items-center">
                            <div id="step2-indicator" class="w-8 h-8 bg-gray-800 border-2 border-gray-700 rounded-full flex items-center justify-center text-white font-bold">2</div>
                            <span class="text-xs mt-1 text-gray-400">Personal</span>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" required
                                            class="w-full py-2.5 pl-10 pr-3 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('first_name') border-red-500 @enderror"
                                            placeholder="John">
                                    </div>
                                    @error('first_name')
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}" required
                                            class="w-full py-2.5 pl-10 pr-3 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('last_name') border-red-500 @enderror"
                                            placeholder="Doe">
                                    </div>
                                    @error('last_name')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    ...
                                    <input type="password" id="password" name="password" required
                                        class="w-full py-2.5 pl-10 pr-3 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('password') border-red-500 @enderror"
                                        placeholder="Minimum 8 characters">
                                </div>
                                @error('password')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-gray-400 text-xs mt-1 italic">Must contain at least 8 characters</p>
                            </div>
                        ...
                        <div id="step2" class="hidden space-y-6 form-appear">
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    ...
                                    <select id="gender" name="gender" required
                                        class="w-full py-2.5 pl-10 pr-10 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm appearance-none transition-all duration-200 @error('gender') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    ...
                                    <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" required
                                        class="w-full py-2.5 pl-10 pr-3 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('date_of_birth') border-red-500 @enderror">
                                </div>
                                @error('date_of_birth')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <input type="number" id="height" name="height" value="{{ old('height') }}" min="50" max="250"
                                            class="w-full py-2.5 pl-10 pr-10 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('height') border-red-500 @enderror"
                                            placeholder="175">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <input type="number" id="weight" name="weight" value="{{ old('weight') }}" step="0.1" min="20" max="300"
                                            class="w-full py-2.5 pl-10 pr-10 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-accent focus:ring focus:ring-accent/20 text-white shadow-sm transition-all duration-200 @error('weight') border-red-500 @enderror"
                                            placeholder="70.5">
                                        <span class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400">
                                            kg
                                        </span>
                            ...
                            <div class="flex space-x-4 pt-6">
                                <button type="button" id="prev-btn" 
                                    class="w-1/3 bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-4 rounded-lg border border-gray-700 shadow focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-300">
                                    <i class="fas fa-arrow-left mr-2"></i> Back
                                </button>
                                <button type="submit" 
                                    class="w-2/3 bg-gradient-to-r from-accent to-darkOrange text-white font-medium py-3 px-4 rounded-lg shadow-lg hover:shadow-accent/50 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-300 transform hover:-translate-y-0.5">
                    ...
                    <div class="mt-6 text-center text-sm">
                        <p class="text-gray-400">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-accent hover:text-darkOrange">
                                Sign in
                            </a>
                        </p>
                    </div>
