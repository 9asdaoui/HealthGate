...
<div class="bg-white rounded-xl shadow-card p-6 card">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                          ...
                                          <div class="p-3 bg-gray-50 rounded-lg">{{ date('M d, Y', strtotime($user->patient->date_of_birth)) }}</div>
                            </div>
...
<div class="p-6">
              ...
              <form action="{{route('patient.updateProfile')}}" method="POST" class="space-y-4" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="text-center mb-4">
                                          <div class="relative inline-block">
                                                        <img id="modal-profile-image" src="{{ $user->image }}" alt="Profile" class="h-24 w-24 rounded-full border-2 border-accent object-cover mx-auto">
                                                        ...
                                                        <input type="file" id="modal-image-upload" name="image" class="hidden" accept="image/*">
                                          </div>
                            </div>
                            
                            <div>
                                          <label for="first_name" class="block text-sm font-medium text-gray-500 mb-1">First Name</label>
                                          <input type="text" id="first_name" name="first_name" class="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-accent/20 focus:border-accent" value="{{ $user->first_name }}">
                            </div>
                            
                            <div>
                                          <label for="last_name" class="block text-sm font-medium text-gray-500 mb-1">Last Name</label>
                                          <input type="text" id="last_name" name="last_name" class="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-accent/20 focus:border-accent" value="{{ $user->last_name }}">
                            </div>
                            
                            <div>
                                          <label for="email" class="block text-sm font-medium text-gray-500 mb-1">Email</label>
                                          <input type="email" id="email" name="email" class="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-accent/20 focus:border-accent" value="{{ $user->email }}">
                            </div>
                            
                            <div>
                                          <label for="date_of_birth" class="block text-sm font-medium text-gray-500 mb-1">Date of Birth</label>
                                          <input type="date" id="date_of_birth" name="date_of_birth" class="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-accent/20 focus:border-accent" value="{{ date('Y-m-d', strtotime($user->patient->date_of_birth)) }}">
                            </div>
