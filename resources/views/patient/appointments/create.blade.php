    ...
    <div class="space-y-6">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <a href="{{ route('patient.appointments') }}"
                class="mt-4 md:mt-0 bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-colors flex items-center justify-center">
            ...
            <form action="{{ route('patient.appointments.create') }}" method="GET" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-end">
                        <button type="submit"
                            class="bg-accent hover:bg-accentHover text-white px-4 py-2 rounded-lg transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                @forelse($doctors as $doctor)
                    <div
                        class="bg-gray-50 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div class="p-5">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <button type="button" onclick="openScheduleModal({{ $doctor->id }})"
                ...
                @empty
                    <div class="col-span-3 py-12 text-center text-gray-500">
                        ...
                        <a href="{{ route('patient.appointments.create') }}"
                            class="mt-3 text-accent hover:underline inline-flex items-center">
    ...
    <div id="scheduleModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
        <div class="bg-white rounded-lg max-w-md w-full max-h-screen overflow-y-auto">
            ...
            <form id="appointmentForm" action="{{ route('patient.appointments.store') }}" method="POST"
                ...
                <div class="mt-6">
                    <button type="submit"
                        class="w-full bg-accent hover:bg-accentHover text-white py-2 px-4 rounded-lg transition-colors">
                        Confirm Appointment
                    </button>
                </div>
            </form>
