    ...
    <div class="space-y-6">
        ...
        <div class="mb-4">
            <a href="{{ route('patient.appointments') }}"
                class="inline-flex items-center text-gray-600 hover:text-accent transition-colors">
            ...
            <div class="grid md:grid-cols-2 gap-6 p-6">
                ...
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-800">Dr.
                                {{ $appointment->doctor->user->first_name ?? '' }}
                                {{ $appointment->doctor->user->last_name ?? '' }}</h3>
                            <p class="text-gray-600">{{ $appointment->doctor->speciality }}</p>
                            <p class="text-gray-500 text-sm mt-1">
                                <i class="fas fa-hospital-alt mr-1"></i>
                                {{ $appointment->doctor->department->name ?? 'Department not assigned' }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-600">Experience: {{ $appointment->doctor->experience ?? 'N/A' }}
                                    years</span>
                            </div>
                            <div class="flex items-center text-sm">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-medium">{{ date('l, F d, Y', strtotime($appointment->appointment_date)) }}</span>
                            </div>
                            <div class="flex justify-between">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    @if ($appointment->status == 'completed')
                        <a href="{{ route('patient.prescription') }}"
                            ...
                            <i class="fas fa-comment-dots mr-1"></i> view prescription
                        </a>
                    @endif
                    <a href="{{ route('patient.appointments') }}"
