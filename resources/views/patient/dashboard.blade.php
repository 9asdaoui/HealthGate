    ...
    <div class="bg-white rounded-xl shadow-card overflow-hidden mb-6">
        <div class="md:flex">
            <div class="p-6 md:flex-1">
                ...
                <p class="text-gray-600 mb-4">Your health dashboard provides a snapshot of your medical information, upcoming
                    appointments, and recent activities.</p>
                <div class="flex flex-wrap gap-3">
                    <a href=""
                        class="bg-accent hover:bg-accentHover text-white px-4 py-2 rounded-lg inline-flex items-center text-sm font-medium transition-all">
                        <i class="fas fa-calendar-plus mr-2"></i> Book Appointment
                    </a>
                    <a href=""
                        class="bg-white border border-accent text-accent hover:bg-accent hover:text-white px-4 py-2 rounded-lg inline-flex items-center text-sm font-medium transition-all">
            ...
            <div class="hidden md:block w-1/3 bg-gradient-to-r from-accent to-darkTeal p-6 text-white">
                ...
                <p class="mb-4 text-sm">Remember to stay hydrated and take regular breaks when working at your computer.
                    Your eye health matters!</p>
                    ...
                    <div class="border border-gray-100 rounded-lg p-4 relative overflow-hidden">
                        ...
                        <div class="flex items-center mb-3 relative z-10">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Last updated: {{ now()->subDays(5)->format('M d, Y') }}
                                </p>
                            </div>
                        </div>
                        <div class="text-gray-800">
        ...
        <div class="md:col-span-4 space-y-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-card card">
                ...
                <div class="flex space-x-2">
                    <a href=""
                        class="flex-1 text-center bg-accent hover:bg-accentHover text-white py-2 px-3 rounded-lg text-sm transition-all">
                        <i class="fas fa-video mr-1"></i> Join Online
                    </a>
                    <a href=""
                        class="flex-1 text-center border border-gray-300 hover:bg-gray-100 text-gray-800 py-2 px-3 rounded-lg text-sm transition-all">
            ...
            <div class="bg-white rounded-xl p-6 shadow-card card">
                ...
                <div class="space-y-3">
                    <a href=""
                        class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all">
                    ...
                    <a href=""
                        class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all">
                        <div
                            class="bg-green-100 h-10 w-10 rounded-lg flex items-center justify-center text-green-500 mr-3">
                    ...
                    <a href=""
                        class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all">
                        <div
                            class="bg-purple-100 h-10 w-10 rounded-lg flex items-center justify-center text-purple-500 mr-3">
                    ...
                    <a href=""
                        class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all">
                        <div
                            class="bg-amber-100 h-10 w-10 rounded-lg flex items-center justify-center text-amber-500 mr-3">
            ...
            <div class="bg-gradient-to-br from-accent/90 to-darkTeal text-white rounded-xl p-6 shadow-card">
                ...
                <p class="mb-4 text-sm">Regular exercise helps improve your heart health, maintain a healthy weight, and
                    boost your mental well-being.</p>
            ...
            <div class="space-y-4">
                ...
                <div class="p-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-all">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div
                                class="bg-blue-100 h-10 w-10 rounded-lg flex items-center justify-center text-blue-500 mr-3">
            ...
            <div class="space-y-4">
                <div class="p-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-all">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-gray-800 font-medium">Dr. Sarah Johnson</p>
                                <p class="text-xs text-gray-500">{{ now()->addDays(3)->format('M d, Y') }} | 10:30 AM |
                                    Cardiology</p>
                            </div>
                        </div>
                        <div class="flex space-x-2">
                            <a href=""
                                class="text-blue-500 hover:bg-blue-100 h-8 w-8 rounded-full flex items-center justify-center">
                                <i class="fas fa-video"></i>
                            </a>
                            <a href=""
                                class="text-red-500 hover:bg-red-100 h-8 w-8 rounded-full flex items-center justify-center">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">{{ now()->addDays(7)->format('M d, Y') }} | 2:00 PM |
                                    Ophthalmology</p>
                            </div>
                        </div>
                        <div class="flex space-x-2">
                ...
                <div class="p-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-all">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div
                                class="bg-purple-500 h-10 w-10 rounded-lg flex items-center justify-center text-white mr-3">
                                <i class="fas fa-user-md"></i>
                            </div>
                            <div>
                                <p class="text-gray-800 font-medium">Dr. Emily Rodriguez</p>
                                <p class="text-xs text-gray-500">{{ now()->addDays(15)->format('M d, Y') }} | 9:15 AM |
                                    General</p>
                            </div>
                        </div>
                        <div class="flex space-x-2">
