...
<div class="container px-6 py-4">
                            ...
                            <div class="md:flex">
                                          <div class="md:w-1/3 bg-gradient-to-br from-indigo-600 to-purple-600 p-6 text-white">
                                                        <div class="flex items-center mb-4">
                                                                      ...
                                                                      <div>
                                                                                    <h2 class="text-2xl font-bold">{{ $patient->user->first_name }} {{ $patient->user->last_name }}</h2>
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4 mt-6">
                                                                      ...
                                                                      <div>
                                                                                    ...
                                                                                    <p class="font-medium">{{ $patient->height ?? '---' }} cm / {{ $patient->weight ?? '---' }} kg</p>
                                                                      </div>
                                                        </div>
                                          </div>
                                          <div class="p-6 md:w-2/3">
                                                        <div class="flex justify-between items-center mb-4">
                                                                      ...
                                                                      <div class="flex space-x-2">
                                                                                    ...
                                                                                    <a href="#" class="px-3 py-1 text-xs bg-green-100 text-green-600 rounded hover:bg-green-200">
                                                        ...
                                                        <div class="grid md:grid-cols-2 gap-6">
                                                                      <div>
                                                                                    ...
                                                                                    <p class="mb-1"><i class="fas fa-envelope text-gray-400 mr-2"></i> {{ $patient->user->email }}</p>
                                                                                    <p class="mb-1"><i class="fas fa-phone text-gray-400 mr-2"></i> {{ $patient->phone ?? 'No phone number' }}</p>
                                                                                    <p><i class="fas fa-map-marker-alt text-gray-400 mr-2"></i> {{ $patient->address ?? 'No address provided' }}</p>
                                                                      </div>
                                                                      
                                                                      <div>
                                                                                    <h4 class="text-sm font-medium text-gray-500 mb-2">Emergency Contact</h4>
                                                                                    <p class="mb-1"><i class="fas fa-user text-gray-400 mr-2"></i> {{ $patient->emergency_contact_name ?? 'Not provided' }}</p>
                                                                                    <p class="mb-1"><i class="fas fa-phone text-gray-400 mr-2"></i> {{ $patient->emergency_contact_phone ?? 'Not provided' }}</p>
                                                                                    <p><i class="fas fa-user-friends text-gray-400 mr-2"></i> {{ $patient->emergency_contact_relationship ?? 'Not specified' }}</p>
                                                                      </div>
                                                        </div>
              ...
              <div id="medical-records" class="tab-content active">
                            <div class="flex justify-between items-center mb-4">
                                          ...
                                          <button type="button" data-modal-target="addMedicalRecordModal" class="px-4 py-2 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                          ...
                                          <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                                                                    ...
                                                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                                                                  ...
                                                                                                  <tr class="hover:bg-gray-50">
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($record->start_date)->format('M d, Y') }}</div>
                                                                                                                </td>
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              <div class="text-sm font-medium text-gray-900">{{ $record->name }}</div>
                                                                                                                </td>
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              <div class="text-sm text-gray-900">Dr. {{ $record->doctor->user->first_name ?? 'Unknown' }} {{ $record->doctor->user->last_name ?? '' }}</div>
                                                                                                                </td>
                                                                                                      
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              <div class="text-sm text-gray-900">{{ $record->dosage }} {{ $record->frequency }}</div>
                                                                                                                </td>
                                                                                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                                                                                    
                                                                                                                              <button type="button" class="text-blue-600 hover:text-blue-900 mr-3" data-record-id="{{ $record->id }}" onclick="editMedicalRecord({{ $record->id }})">
                                                                                                                                            <i class="fas fa-edit"></i>
                                                                                                                              </button>
                                                                                                                              <button type="button" class="text-red-600 hover:text-red-900" data-record-id="{{ $record->id }}" onclick="deleteMedicalRecord({{ $record->id }})">
                                                        ...
                                                        <div class="px-6 py-3 bg-gray-50 flex justify-between items-center">
                                                                      <div class="text-sm text-gray-500">
                                                                                    Showing {{ $medicalRecords->firstItem() ?? 0 }} to {{ $medicalRecords->lastItem() ?? 0 }} of {{ $medicalRecords->total() ?? 0 }} records
                                                                      </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-6 mb-6">
                                          ...
                                          <div class="bg-white rounded-xl shadow-sm p-4">
                                                        <div class="flex justify-between items-center mb-4">
                                                                      ...
                                                                      <button type="button" data-modal-target="addBloodPressureModal" class="px-3 py-1 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700">
                                          ...
                                          <div class="bg-white rounded-xl shadow-sm p-4">
                                                        <div class="flex justify-between items-center mb-4">
                                                                      ...
                                                                      <button type="button" data-modal-target="addBloodSugarModal" class="px-3 py-1 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700">
                                                                                    <i class="fas fa-plus mr-1"></i> Add Reading
                                                                      </button>
                                                        </div>
                                                        <div class="h-64">
                                          ...
                                          <div class="bg-white rounded-xl shadow-sm p-4">
                                                        <div class="flex justify-between items-center mb-4">
                                                                      ...
                                                                      <button type="button" data-modal-target="addHeartRateModal" class="px-3 py-1 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700">
                                                                                    <i class="fas fa-plus mr-1"></i> Add Reading
                                                                      </button>
                                                        </div>
                                                        <div class="h-64">
                                          ...
                                          <div class="bg-white rounded-xl shadow-sm p-4">
                                                        <div class="flex justify-between items-center mb-4">
                                                                      ...
                                                                      <button type="button" data-modal-target="addWeightModal" class="px-3 py-1 bg-indigo-600 text-white text-xs rounded-lg hover:bg-indigo-700">
                                                                                    <i class="fas fa-plus mr-1"></i> Add Reading
                                                                      </button>
                                                        </div>
                                                        <div class="h-64">
                            ...
                            <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
                                          <div class="px-4 py-3 bg-gray-50 border-b">
                                                        <div class="flex justify-between items-center">
                                                                      ...
                                                                      <div class="flex space-x-2">
                                                                                    <button type="button" class="px-3 py-1 bg-blue-100 text-blue-600 rounded text-xs hover:bg-blue-200">
                                          ...
                                          <div class="overflow-x-auto">
                                                        <table class="min-w-full divide-y divide-gray-200">
                                                                      ...
                                                                      <tbody class="bg-white divide-y divide-gray-200">
                                                                                    ...
                                                                                    <tr class="hover:bg-gray-50">
                                                                                                  <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($metric['date'])->format('M d, Y H:i') }}</div>
                                                                                                  </td>
                                                                                                  <td class="px-6 py-4 whitespace-nowrap">
                                                                                                  ...
                                                                                                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                                                                                <button type="button" class="text-blue-600 hover:text-blue-900 mr-3" data-metric-id="{{ $metric['id'] }}" onclick="editMetric('{{ $metric['type'] }}', {{ $metric['id'] }})">
                                                                                                                              <i class="fas fa-edit"></i>
                                                                                                                </button>
                                                                                                                <button type="button" class="text-red-600 hover:text-red-900" data-metric-id="{{ $metric['id'] }}" onclick="deleteMetric('{{ $metric['type'] }}', {{ $metric['id'] }})">
                                                                                                                              <i class="fas fa-trash"></i>
                                                                                                                </button>
                                                                                                  </td>
                                                                                    </tr>
              ...
              <div id="diseases" class="tab-content">
                            <div class="flex justify-between items-center mb-4">
                                          ...
                                          <button type="button" data-modal-target="addDiseaseModal" class="px-4 py-2 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                          ...
                                          <div class="grid md:grid-cols-2 gap-6 mb-6">
                                                        ...
                                                        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                                                      <div class="px-6 py-4 flex justify-between items-center border-b">
                                                                                    ...
                                                                                    <div class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-{{ $disease->category === 'chronic' ? 'red' : 'yellow' }}-100 text-{{ $disease->category === 'chronic' ? 'red' : 'yellow' }}-800">
                                                                      ...
                                                                      <div class="px-6 py-4">
                                                                                    ...
                                                                                    <div class="mt-4 grid grid-cols-2 gap-4">
                                                                                                  <div>
                                                                                                                ...
                                                                                                                <p class="text-sm font-medium">{{ \Carbon\Carbon::parse($disease->pivot->created_at)->format('M d, Y') }}</p>
                                                                                                  </div>
                                                                                                  <div>
                                                                                                                <h5 class="text-xs font-medium text-gray-500 mb-1">Diagnosed By</h5>
                                                                                                                <p class="text-sm font-medium">Dr. {{ $disease->pivot->doctor->user->first_name ?? 'Unknown' }} {{ $disease->pivot->doctor->user->last_name ?? '' }}</p>
                                                                                                  </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="mt-4">
                                                                                                  ...
                                                                                                  <div class="flex flex-wrap">
                                                                                                                ...
                                                                                                                <span class="m-1 px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs">{{ trim($symptom) }}</span>
                                                                                                                @endforeach
                                                                                                  </div>
                                                                                    </div>
                                                                                    @endif
                                                                      ...
                                                                      <div class="px-6 py-3 bg-gray-50 flex justify-end space-x-2">
                                                                                    <button type="button" class="px-3 py-1 bg-blue-100 text-blue-600 text-xs rounded hover:bg-blue-200" onclick="editDisease({{ $disease->id }})">
                                                                                                  <i class="fas fa-edit mr-1"></i> Edit
                                                                                    </button>
                                                                                    <button type="button" class="px-3 py-1 bg-red-100 text-red-600 text-xs rounded hover:bg-red-200" onclick="deleteDisease({{ $disease->id }})">
                                                                                    ...
                                                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                                                                  ...
                                                                                                  <tr class="hover:bg-gray-50">
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              ...
                                                                                                                              <div class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($appointment->start_time)->format('h:i A') }} - {{ \Carbon\Carbon::parse($appointment->end_time)->format('h:i A') }}</div>
                                                                                                                </td>
                                                                                                                <td class="px-6 py-4 whitespace-nowrap">
                                                                                                                              <div class="flex items-center">
                                                                                                                                            <div class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-500 mr-2">
                                                                                                                ...
                                                                                                                <td class="px-6 py-4">
                                                                                                                              <div class="text-sm text-gray-900 max-w-xs truncate">{{ $appointment->notes ?? 'No notes available' }}</div>
                                                                                                                </td>
                                                                                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                                                                                              <button type="button" class="text-indigo-600 hover:text-indigo-900 mr-3" onclick="viewAppointment({{ $appointment->id }})">
                                          ...
                                          <form action="{{ route('doctor.medical.store') }}" method="POST">
                                                        ...
                                                        <div class="px-4 py-3">
                                                                      ...
                                                                      <div class="grid grid-cols-2 gap-4 mb-4">
                                                                                    <div>
                                                                                                  <label for="dosage" class="block text-sm font-medium text-gray-700">Medication Dosage</label>
                                                                                                  <input type="text" name="dosage" id="dosage" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                                                    </div>
                                                                                    
                                                                                    <div>
                                                                                                  <label for="frequency" class="block text-sm font-medium text-gray-700">Frequency</label>
                                                                                                  <input type="text" name="frequency" id="frequency" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                                                    </div>
                                                                      </div>
                                          ...
                                          <form action="{{ route('doctor.diseases.assign') }}" method="POST">
                                                        ...
                                                        <div class="px-4 py-3">
                                                                      <div class="mb-4">
                                                                                    ...
                                                                                    <select name="disease_id" id="disease_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                                      ...
                                                                      <div class="mb-4">
                                                                                    <label for="duration" class="block text-sm font-medium text-gray-700">Duration (if applicable)</label>
                                                                                    <input type="text" name="duration" id="duration" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="e.g. 2 weeks, 3 months, chronic">
                                                                      </div>
                                                        </div>
